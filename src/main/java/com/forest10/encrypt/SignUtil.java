...
public class SignUtil {
    ...
    private static final String[] DEFAULT_EXCLUDE_SIGN_KEY = {"sign", "sign_type", "key"};
    ...
    private static Map<String, Object> grepEmptyValueAndExcludeKey(Map<String, Object> params) {
        List<String> excludeKeys = Stream.of(DEFAULT_EXCLUDE_SIGN_KEY)
    ...
    private static String signParams(Map<String, Object> params, String secret) {
        ...
        signPairs.forEach(str -> signBeforeMd5.append(str)
            .append("&"));
        signBeforeMd5.deleteCharAt(signBeforeMd5.lastIndexOf("&"));

        return Md5Util.md5Encode(signBeforeMd5.toString())
            .toUpperCase();
