...
public class MybatisAopInterceptor implements Interceptor {
    ...
    public void setProperties(Properties properties) {
        this.largeInsertSize =
            Integer.parseInt(properties.getProperty("largeInsertSize", String.valueOf(largeInsertSize)));
        this.largeDeleteSize =
            Integer.parseInt(properties.getProperty("largeDeleteSize", String.valueOf(largeDeleteSize)));
        this.largeUpdateSize =
            Integer.parseInt(properties.getProperty("largeUpdateSize", String.valueOf(largeUpdateSize)));
        this.largeSelectSize =
            Integer.parseInt(properties.getProperty("largeSelectSize", String.valueOf(largeSelectSize)));
    }
     ...
     */
    private void preHandleAnnotation(MappedStatement mappedStatement, Object parameter, SqlCommandType sqlCommandType)
        throws ClassNotFoundException {
    ...
    private void logSql(MappedStatement mappedStatement, Object parameter, String sql, double size, int threshold) {
        if (size >= threshold) {
            log.error("LARGE SIZE SQL INFO:method=>{},sql=>{},parameter=>{},size=>{}", mappedStatement.getId(), sql,
                parameter, size);
        }
    }
}