...
public class BizPreconditions {
     ...
     * @throws BizException if {@code reference} is null or empty
     */
    public static <T> List<T> checkNotEmpty(List<T> reference, String errorMessageTemplate,
     ...
     * @throws BizException if {@code reference} is null or empty
     */
    public static <T> Set<T> checkNotEmpty(Set<T> reference, String errorMessageTemplate, Object... errorMessageArgs) {
        if (reference == null || Iterables.isEmpty(reference)) {
            // If either of these parameters is null, the right thing happens anyway
            throw new BizException(errorMessageTemplate, errorMessageArgs);
        }
     ...
     * @throws BizException if {@code reference} is null or empty
     */
    public static <T> Iterable<T> checkNotEmpty(Iterable<T> reference, String errorMessageTemplate,
        Object... errorMessageArgs) {
        if (reference == null || Iterables.isEmpty(reference)) {
            // If either of these parameters is null, the right thing happens anyway
            throw new BizException(errorMessageTemplate, errorMessageArgs);
