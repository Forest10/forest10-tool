package forest10.web.conf;

import com.google.common.collect.Lists;
import forest10.web.annotation.EnableLogFilter;
import forest10.web.filter.realize.LogFilter;
...
public class LogFilterConf implements ImportAware {
	...
	public void setImportMetadata(AnnotationMetadata importMetadata) {
		AnnotationAttributes enableLogFilter = AnnotationAttributes.fromMap(importMetadata.getAnnotationAttributes(EnableLogFilter.class.getName(), false));
		Assert.notNull(enableLogFilter, "@EnableLogFilter is not present on importing class " + importMetadata.getClassName());
